...
Tags: hide post,post hide,posts,wordpress hide post
Donate link: https://codecanyon.net/item/wordpress-hide-post/24141817?s_rank=2
...
= Premium link =
[WP Post hide](https://codecanyon.net/item/wordpress-hide-post/24141817?s_rank=3)


== Installation ==
Upload WP Post Hide to the `/wp-content/plugins/` directory
Activate the plugin through the \'Plugins\' menu in WordPress.

== Frequently Asked Questions ==
= How to install this plugin? =
Upload the wp-post-hide folder to the /wp-content/plugins/ directory
Activate the plugin through the Plugins menu in WordPress
That's it! Now whenever you edit a post/page or create a new one, you will see a small panel on the bottom right of the screen that shows the applicable options.
